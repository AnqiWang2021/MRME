...
#' @param par_est A vector, the estimates for beta and gamma.  Beta is the parameter in the linear regression model of
...
#' @return A list
#' \describe{
#' \item{cov_matrix}{the covariance matrix of the final estimates for beta and gamma.}
#' \item{se}{the variance of the final estimates for beta and gamma}
#'  }
#' @export
#'
